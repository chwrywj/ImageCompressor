  ...
  <el-container>
    ...
    <el-footer>
      <div class="footer">
        ...
        <div class="item" @click="openBrowser('https://toollist.net/compress-image-desktop-app')">
          <i class="my-icon my-icon-tech-support"></i>
          <span>{{$t('common.support')}}</span>
        </div>
        <div class="item" @click="openBrowser('https://toollist.net/Donata?from=ImageCompress')">
